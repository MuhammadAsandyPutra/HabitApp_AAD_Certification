...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        val textTitle = itemView.findViewById<TextView>(R.id.pager_tv_title)
        val itemPrioriy = itemView.findViewById<ImageView>(R.id.pager_priority_level)
        val textStart = itemView.findViewById<TextView>(R.id.pager_tv_start_time)
        val textMinute = itemView.findViewById<TextView>(R.id.pager_tv_minutes)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            with(pageData) {
                ...
                textMinute.text = minutesFocus.toString()
            }

            if (pageType == PageType.HIGH){
                itemPrioriy.setImageResource(R.drawable.ic_priority_high)
            }else if (pageType == PageType.MEDIUM){
                itemPrioriy.setImageResource(R.drawable.ic_priority_medium)
            }else if (pageType == PageType.LOW){
                itemPrioriy.setImageResource(R.drawable.ic_priority_low)
            }
